...
/**
 * str_duplicate - duplicates a null-terminated string.
 *
...
/**
 * str_compare - Compare two null-trminated strings.
 *
 * @string1: string one to be compared.
 * @string2: string two to be compared.
...
/**
 * str_reverse - reverses a null-terminated string.
 *
 * @string: pointer to string.
 *
 * Return: void.
...
void str_reverse(char *string)
{
	...
	int r = 0, length = str_length(string) - 1;
	char hold;
